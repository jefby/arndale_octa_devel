...
#define GetEvtNum()	(GetBits(PRODUCT_ID, 4, 0xf))/*取地址0x10000000[7:4]的值*/
#define GetEvtSubNum()	(GetBits(PRODUCT_ID, 0, 0xf))/*取地址0x10000000[3:0]的值*/
#define GetPopOption()	(GetBits(PKG_ID, 4, 0x3))/*取地址0x10000004[5:4]的值*/
#define GetDdrType()	(GetBits(PKG_ID, 14, 0x1))/*地址0x100000004[14]的值*/
